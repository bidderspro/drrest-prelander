                        ...
                        <div className="flex-1 flex flex-col gap-6">
                          <div className="space-y-3">
                            <div className="space-y-2">
                              <h3 className="text-xl font-semibold font-['Poppins'] text-zinc-800">
                                Dr. RestRight Mouth Tape
                              </h3>
                              <p className="text-neutral-500 text-sm font-normal font-['Poppins']">
                                Dr. RestRight was the clear winner across every
                                category.
                              </p>
                            </div>
                            <div className="space-y-2">
                              <h4 className="text-base font-semibold font-['Poppins'] text-zinc-800">
                                Description:
                              </h4>
                              <p className="text-base font-normal font-['Poppins'] text-zinc-800">
                                Held securely all night, but peeled off gently
                                in the morning.
                                <br />
                                Hypoallergenic adhesive worked even for
                                sensitive skin.
                                <br />
                                Unique doctor-formulated aromatherapy options
                                (lavender or chamomile-lavender) calmed the
                                nervous system before sleep.
                                <br />
                                Breathable design allowed safe airflow in case
                                of nasal congestion.
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="flex-1 flex flex-col gap-6">
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-base font-normal font-['Poppins'] text-zinc-800">
                            ...
                            <br />
                            But lacked strong adhesion — several testers found
                            it peeled off during the night.
                            <br />A good starter option, but not reliable for
                            consistent results.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-zinc-800 text-base font-normal font-['Poppins'] line-through">
                            $25.00
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-base font-normal font-['Poppins'] text-zinc-800">
                            ...
                            <br />
                            But "too strong" for some — several testers
                            experienced irritation and sticky residue.
                            <br />
              ...
              <div className="max-w-4xl flex flex-col gap-6">
                ...
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      filter: "drop-shadow(0 0 20px rgba(0, 200, 143, 0.25))",
                    }}
                  >
                    {/* Background SVG */}
                    <div className="absolute inset-0 w-full h-full">
                      ...
                      >
                        <g filter="url(#filter0_d_12_594)">
                          <path
                            d="M865 20C878.255 20 889 30.7452 889 44V347C889 360.255 878.255 371 865 371H44C30.7452 371 20 360.255 20 347V125.627C20 114.58 31.9527 107 43 107H278C307.823 107 332 82.8234 332 53C332 52.0233 331.974 51.0527 331.923 50.0887C331.217 36.8145 340.047 20 353.34 20H865Z"
                            fill="white"
                          />
                        </g>
                        <defs>
                          ...
                          >
                            ...
                            <feBlend
                              ...
                              result="effect1_dropShadow_12_594"
                            />
                            <feBlend
                              mode="normal"
                              in="SourceGraphic"
                              in2="effect1_dropShadow_12_594"
                              result="shape"
                            />
                          </filter>
                        </defs>
              ...
              <div className="bg-blue-100 rounded-2xl p-6 lg:p-8">
                <div className="flex flex-col sm:flex-row gap-6 items-start">
                  ...
                  <div className="flex-1 space-y-4">
                    <h3 className="text-zinc-800 text-xl font-semibold font-['Poppins'] leading-loose">
                      Leo B.
                    </h3>
                    <div className="text-base font-normal font-['Poppins'] leading-normal text-zinc-800">
                      ...
                      <span>
                        {" "}
                        is a trusted resource for practical, no-nonsense sleep
                        advice, founded by Dr. Stephen Taylor — a 52 year old
                        physician who personally battled years of snoring, CPAP
                        frustration, and restless nights. After seeing how poor
                        sleep was stealing energy and health from both his
          ...
          <aside className="w-full sm:w-[22rem] lg:w-80 xl:w-96 flex-shrink-0">
            <div className="sticky top-6 sm:top-8">
              <div className="relative">
                ...
                {/* Top Pick Badge */}
                <div className="absolute left-2 top-2 sm:left-2.5 sm:top-2.5 bg-emerald-500 rounded-full px-6 py-2 sm:px-8 sm:py-3">
                  <div className="flex items-center gap-1 sm:gap-2">
                    ...
                    <span className="text-white text-sm sm:text-base font-semibold font-['Poppins']">
                      Top Pick
                    </span>
                  </div>
                </div>
                ...
                <div className="absolute inset-0 px-4 py-4 sm:px-5 sm:py-5 flex flex-col justify-end items-center">
                  <div className="w-full sm:w-80 space-y-6 sm:space-y-9">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      ...
                      <button className="w-full h-12 sm:h-14 px-3 py-2 bg-blue-700 rounded-xl text-white text-sm sm:text-base font-medium font-['Poppins'] hover:bg-blue-800 transition-colors">
                        GET 20% OFF
                      </button>
                    </div>
                  </div>
